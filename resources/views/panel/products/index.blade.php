...
<body>
              ...
              <div class="modal fade" id="verticalycentered" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    ...
                    <form action="{{ route('product.store') }}" method="post" class="mt-2" enctype="multipart/form-data">
                        @csrf
                نام:<input type="text"name="title"class="mt-2 form-control"><br>
 ...
 @endforeach
                ...
                موجودی:<input type="text"name="qty" class="mt-2 form-control"><br>
                قیمت:<input type="text"name="price" class="mt-2 form-control"><br>
                عکس:<input type="file"name="image"class="mt-2 form-control"><br><br>
                توضیحات:<textarea name="product_detail"class="mt-2 form-control" cols="45" rows="10" wrap="virtual" ></textarea><br>
